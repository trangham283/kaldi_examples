...
# FROM steps/online/nnet3/decode.sh
# Changed a few things below
...
if [ "$post_decode_acwt" == 1.0 ]; then
  ...
  #lat_wspecifier="ark,t:$dir/output.JOB.lat"
else
  lat_wspecifier="ark:|lattice-scale --acoustic-scale=$post_decode_acwt ark:- ark:- | gzip -c >$dir/lat.JOB.gz"
  #lat_wspecifier="ark:|lattice-scale --acoustic-scale=$post_decode_acwt ark:- ark,t:$dir/output.JOB.${post_decode_acwt}.lat"
fi
